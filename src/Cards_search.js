...
class SimpleCardSearch extends React.Component{

  state = {
        items: [],
  };

  items2 = this.props.items_

  componentDidMount() {
    this.setState({items:this.items2})
  }
...
export default withStyles(styles)(SimpleCardSearch);